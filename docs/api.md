> 最終更新: 2026-04-09 (T38: upsertManagerEvaluationAction を廃止し、manager_comments 用 Server Actions を追加)
...
| `fiscalYear` | `number` | YES | 1900〜9999 の整数 |
| `evalItemId` | `number` | YES | 1 以上の整数 |
| `data.score` | `Score` | YES | `"none" \| "ka" \| "ryo" \| "yu"` |
...
| `data.score` | `Score` | NO | `"none" \| "ka" \| "ryo" \| "yu"` |
| `data.reason` | `string \| null` | NO | — |
